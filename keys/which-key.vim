...
let g:which_key_map.e = {
      \ 'name' : '+explorer' ,
      \ 'e' : [':CocCommand explorer --toggle --sources=file+ --width=40'        , 'explorer'],
      \ 'c' : [":call CocAction('runCommand', 'explorer.doAction', 'closest', ['reveal:0'], [['relative', 0, 'file']])<CR>"    , 'current file'],
      \ }
